...
import trucks from "../../../public/subcategories/agricultural_machinery_data.json";
...
export default function AgriculturalMachinery({ data }) {
  const trucksData = trucks["agricultural_machinery"];
