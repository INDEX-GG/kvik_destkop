...
import truckCranes from "../../../public/subcategories/communal_machinery_data.json";
import { OnlyNumbersMask } from "../../../lib/onlyNumbersMask";
...
export default function CommunalMachinery({ data }) {
  const trucksData = truckCranes["communal_machinery"];
