...
export default function SellhouseAndCottages({ data }) {
            ...
            return (
              <Box key={idx} className={classes.formElem}>
                <Typography
                  ...
                  style={{
                    maxWidth:
                      item.alias === "battery_life" || item.alias === "builtin_memory" ? 158 : null,
                  }}
                >
                  {item.name}
                </Typography>
            ...
            case "textRec":
              ...
              <Box className={classes.formInputField}>
                <Controller
                  ...
                  control={methods.control}
                  defaultValue=""
                  rules={{required: "Введите "+ item.name, pattern: /[0-9]+/}}
                  render={({ field: { onChange, value }, fieldState: { error } }) => (
                    <TextField
                      className={classes.input}
                      variant="outlined"
