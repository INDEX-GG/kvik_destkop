...
import trucks from "../../../public/subcategories/forestry_equipment_data.json";
...
export default function ForestryEquipment({ data }) {
  const trucksData = trucks["forestry_equipment"];
