...
export function modalRating(rate) {
  return (
    <div className="modal__wrapper_md" >
      ...
      <div className="modal__block__middle" >
        ...
        <p className="modal__block__middle_rating_description">Здесь будут отображаться отзывы,<br />и на их основе составляться ваш рейтинг</p>
      </div>
    </div>
  )
}
...
export function modalSubscribers(data) {
  return (
    <div className="modal__wrapper_md" >
      <div className="modal__block__top">
...
export function modalSubscription(data) {
  return (
    <div className="modal__wrapper_md" >
      <div className="modal__block__top">
  ...
  return (
    <div className="modal__wrapper" >
      ...
      <div className="modal__block_btn ">
        <a className="btn-blue" href="">ОТМЕНА</a>
        <a className="btn-red" href="">ВЫЙТИ</a>
      </div>
    </div>
  )
}
...
export function modalDeleteAccount() {
  return (
    <div className="modal__wrapper" >
      <h6 className="modal__block_title">Вы уверены удалить аккаунт? <br />Аккаунт будет удален навсегда</h6>

      <div className="modal__block_btn ">
        <a className="btn-blue" href="">ОТМЕНА</a>
        <a className="btn-red" href="">УДАЛИТЬ</a>
      </div>
    </div>
  )
}
...
export function modalDeletHistory() {
  return (
    <div className="modal__wrapper" >
      ...
      <div className="modal__block_btn ">
        <a className="btn-blue" href="">ОТМЕНА</a>
        <a className="btn-red" href="">ОЧИСТИТЬ</a>
      </div>
    </div>
  )
}
