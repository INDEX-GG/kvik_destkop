...
const SearchBlock = ({value}) => {
    ...
    const dictionaryOfAnimals = [
        'лягушка', 'кошка', 'собака', 'щенок', 'крот', 'пёсик', 'котенок', 'корова', 'рыбка', 'крыса', 'rjn', 'кот', 'пёс', 'трубкозуб', 'абиссинский', 'аддакс',
        ...
        'амазонский речной дельфин (розовый дельфин)', 'американская овчарка', 'американский бульдог', 'американский кокер-спаниель', 'американская енотовидная собака',
        ...
        'термит', 'тигр', 'жаба', 'форель', 'турция', 'черепаха', 'гадюка', 'стервятник', 'кенгуру', 'морж', 'оса', 'ласка', 'кит', 'дикая кошка', 'волк', 'росомаха',
