...
import n from '../../../public/subcategories/sell_rooms.json'
...
const ProductSellRoomInformation = ({data, mobile, description}) => {
  const classes = useClass()
  const names = n['sell_rooms']
...
export default ProductSellRoomInformation;
