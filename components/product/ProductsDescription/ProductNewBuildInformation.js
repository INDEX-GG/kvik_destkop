...
import n from '../../../public/subcategories/new_building.json'
...
const ProductNewBuildInformation = ({data, mobile, description}) => {
  const classes = useClass()
  const names = n['new_building']
...
export default ProductNewBuildInformation;
