...
const ProductTechInformation = ({data, mobile, description, productData}) => {
    ...
    useEffect(() => {
        ...
        if (productData) {
            setProducts([...productData?.filter(el => el.alias !== "features" &&
                ...
                {alias: "desc"},
                ...productData?.filter(el => el.alias === "features" ||
                    el.alias === "body_material" ||
                    el.alias === "connectors_and_interfaces" ||
                    el.alias === "features_of_the" ||
                    el.alias === "features_of_the_body" ||
                            ...
                            if (data[el.alias] || el.alias === 'desc') {
                                ...
                                if (el.alias === "charge_power") return (
                                    <div className="productWrap" key={i} style={{border: "none"}}>
                                        <div className="productLocality" style={{padding: "14px 0"}}>{el.name}</div>
                                        <pre className='productDescription'
                                             style={{margin: "14px 0"}}>{data[el.alias]} Вт</pre>
                                    </div>
                                )
                                if (el.alias === "the_weight" || el.alias === "tv_year") return (
                                    <div className="productWrap" key={i} style={{border: "none"}}>
                                        <div className="productLocality" style={{padding: "14px 0"}}>{el.name}</div>
                                        <pre className='productDescription'
                                             style={{margin: "14px 0"}}>{data[el.alias]} г.</pre>
                                    </div>
                                )
