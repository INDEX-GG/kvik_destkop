      ...
      <div key={offer.id} className="offerContainer boxWrapper">
        <div className="offerImage">
          ...
          {offer.verify == 4 ?
            ...
            <div className="offerWaitCause megaLight"><p>Отклонено/Заблокировано</p></div>}
        ...
        <div className="offerDescription">
          ...
          <div className="offerDescriptionBottom">
            ...
            <div className="offerDescriptionBottomEnd">
              <div className="offerSocialCount offerSocialCountPos offerRightBottomNull">
                <div className="offerShowes showesIcon">{offer.last_day_viewing_count} +{offer.all_time_contact_count}</div><div className="showesIcon"></div>
