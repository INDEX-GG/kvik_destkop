      ...
      <div className="clientPage__container_bottom">
         <div className="clientPage__container_content">
            <div className="privateDataWrapper thin">
               ...
               <div>
                  <div>История</div>
                  <a onClick={e => { modalOlen(e, 'sm', modalDeletHistory()) }} className="offerUnpublish thin superLight">Очистить историю поиска</a>
                  <div>Очистить</div>
               </div>
               <div>
                  <div>Выход</div>
               ...
               <div>
                  ...
                  <a onClick={e => { modalOlen(e, 'sm', modalDeleteAccount()) }} className="offerUnpublish thin superLight">Удалить навсегда</a>
               </div>
               <div>
