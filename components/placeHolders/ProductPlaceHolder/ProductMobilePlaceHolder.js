		...
		<Box className={classes.skeletonContainer}>
			<Grid container rowSpacing={1}>
				...
				<Grid
					...
					md={10}
					spacing={4}
					sx={{ marginLeft: 2, marginBottom: "5px", marginTop: "15px" }}
				>
					<Box sx={{ height: "40%" }}>
						<Skeleton
							animation="wave"
				...
				<Grid
					...
					md={12}
					spacing={4}
					sx={{ marginLeft: 2, marginBottom: "7px" }}
				>
					<Skeleton
						animation="wave"
						variant="rectangular"
				...
				<Grid container className={clsx(classes.skeletonCenter)}>
					<Skeleton
						animation="wave"
						variant="rectangular"
						width="159px"
