...
//
//
//             // Добавить проверку массива с id постов на наличие строк
//
//
//
//
//             let unlike_posts  = await pool.query(`DELETE FROM "favorites" WHERE user_id = $1 AND liked_post_id IN (${[...new Set(req.body.posts)]}) RETURNING liked_post_id`, [req.body.user_id])
