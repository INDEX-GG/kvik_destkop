...
export default async function handler(req, res) {
    if (req.method === 'POST') {
        ...
        try {
            ...
            res.json('ошибка api getPostCheck, ' + e.toString())
            res.status(405).end();
        }
        finally {
            await pool.end();
