function initials() {
    if (this.indexOf(' ') === -1) {
        ...
        return `${this.substr(0, 1)}${this.substr(this.indexOf(' ') + 1, 1)}`
    }
}
...
export { initials, stringToColor, brooklyn, standartDate, addZero, ellipsis, ToRubles, ToRusDate, ToFullDate, ToRusAccountDate, phoneNumber, typeChange, getDataByQuery };