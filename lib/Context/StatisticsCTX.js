    ...
    useEffect(() => {
        ...
        if(local !== null && !id) {
                ...
                if(local?.unsubscribe !== undefined) {
                    obj.subscribe = [...obj?.unsubscribe, ...local?.unsubscribe]
                }

                if(local?.view !== undefined) {
                    obj.view = [...obj?.view, ...local?.view]
                }

                if(local?.clickContact !== undefined) {
                    obj.clickContact = [...obj?.clickContact, ...local?.clickContact]
                }
